...
tx_county_sp = tigris::counties(state = 48, year = 2018, class = 'sf')  # sf (modern tigris)
...
ggsave(plot = big_grob,filename = 'output/v2/figureA2.png',height=10,width = 9,units = 'in',dpi = 500)
...
big_grob = grid.arrange(grobs = strata_grobs,ncol = 2,
                        ...
                        bottom ="May 4, 2010 to July 7, 2015")
ggsave(plot = big_grob,filename = 'output/v2/figureA3.png',height=10,width = 9,units = 'in',dpi = 500)
...
ggsave(plot = gg_district_hazards,filename = 'output/v2/figureA4.png',height=6,width = 5,units = 'in',dpi = 500)
