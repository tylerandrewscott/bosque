...
tx_info2 = as.data.table(readRDS('bosquebox/input/texas_dww/pws_details_2019-07-02.RDS'))
...
tx_connections = fread('bosquebox/input/twdb_historicalestimates/20170630_Connections.csv',na.strings = "-")
