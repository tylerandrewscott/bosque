...
twd_boundaries <- st_read('bosquebox/input/Water_Districts/Water_Districts.shp')
...
precints <- st_read('bosquebox/spatial_inputs/princeton-ww72bg01w-geojson.json')
precints$COUNTY_VTD <- paste0('48',precints$COUNTYFP10,'_',precints$VTDST10)
elections <- list.files('input/precinct_votes/',full.names =T)
...
saveRDS(pws_demos_dt,file = 'input/pws_demos_MR.RDS')
